...
console.log(`El material que debo llevar es${miCamino.material}`)
...
for (const i = 0; i < miCamino.material.length; i++) { 
   if ( i===0 ) {
    console.log(`Lo primero que debo  llevar es ${material.nombre}y es ${material.descripcion}`);
   } else if (i === 1) {
    console.log(`Lo segundo que debo de llevar es ${material.nombre}y es ${material.descripcion}`);
   } else if (i === 2) {
    console.log(`Lo tercero que debo llevar es ${material.nombre}y es ${material.descripcion}`);
   } else (i === 3) {
    console.log(`y por ultimo debo llevar la ${material.nombre}y es ${material.descripcion}`);
   }
  }

//5º: vamos a decir: para subir al {nombre de la cima}  debo subir {altura } metros y debo viajar a {ubicacion}
for (const ownWay of miCamino.cimas) {

  console.log(`Para subir al ${ownWay.nombre}debo subir ${ownWay.altitud} metros y debo viajar a ${ownWay.localizacion}`)
}
...
console.log(miCamino.subiendoAlEverest[0][0].campoBase[0]);
